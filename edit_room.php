...
// Ambil data room
$stmt = $conn->prepare("SELECT * FROM ruang WHERE id = ?");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Handle image upload
    $image = $room['image']; // Keep existing image by default
    if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
        ...
        if (in_array($_FILES['image']['type'], $allowed_types) && $_FILES['image']['size'] <= $max_size) {
            ...
            if (move_uploaded_file($_FILES['image']['tmp_name'], $upload_path)) {
                ...
                if ($room['image'] && file_exists($upload_dir . $room['image'])) {
    ...
    if (!isset($error_message)) {
        $sql = "UPDATE ruang SET name = ?, description = ?, type = ?, capacity = ?, location = ?, status = ?, image = ? WHERE id = ?";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("sssssssi", $name, $description, $type, $capacity, $location, $status, $image, $room_id);
...
<head>
    ...
    <title>Edit Room | Room Booking</title>
...
<body>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item active">
                        <a href="#" class="menu-link">
                            ...
                            <div data-i18n="Edit Room">Edit Room</div>
                        </a>
                    </li>
                </ul>
            </aside>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="edit_room.php?id=<?php echo $room_id; ?>" enctype="multipart/form-data">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="type" name="type" required>
                                                    ...
                                                    <option value="Meeting Room" <?php echo ($room['type'] == 'Meeting Room') ? 'selected' : ''; ?>>Meeting Room</option>
                                                    <option value="Conference Hall" <?php echo ($room['type'] == 'Conference Hall') ? 'selected' : ''; ?>>Conference Hall</option>
                                                    <option value="Training Room" <?php echo ($room['type'] == 'Training Room') ? 'selected' : ''; ?>>Training Room</option>
                                                    <option value="Seminar Room" <?php echo ($room['type'] == 'Seminar Room') ? 'selected' : ''; ?>>Seminar Room</option>
                                                    <option value="Classroom" <?php echo ($room['type'] == 'Classroom') ? 'selected' : ''; ?>>Classroom</option>
                                                    <option value="Auditorium" <?php echo ($room['type'] == 'Auditorium') ? 'selected' : ''; ?>>Auditorium</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <?php if ($room['image']): ?>
                                                    <div class="mb-2">
                                                        <img src="uploads/rooms/<?php echo $room['image']; ?>" alt="Current Image" class="img-thumbnail" style="max-width: 200px;">
                                        ...
                                        <div id="preview">
                                            <div class="d-flex align-items-center justify-content-start">
                                                ...
                                                <div class="text-start">
                                                    ...
                                                    <small class="text-muted"><?php echo htmlspecialchars($room['type']); ?> • <?php echo $room['capacity']; ?> people</small><br>
                                                    <small class="text-muted"><?php echo htmlspecialchars($room['location']); ?></small><br>
                                                    <span class="badge bg-label-<?php echo $room['status'] == 'available' ? 'success' : ($room['status'] == 'maintenance' ? 'warning' : 'danger'); ?>">
    ...
    <script>
        ...
        function updatePreview() {
            ...
            if (name && type && capacity && location && status) {
                let statusClass = '';
                switch(status) {
                ...
                preview.innerHTML = `
                    <div class="d-flex align-items-center justify-content-start">
                        ...
                        <div class="text-start">
                            ...
                            <small class="text-muted">${type} • ${capacity} people</small><br>
