...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO ruang (name, description, type, capacity, location, status, image) VALUES (?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssssss", $name, $description, $type, $capacity, $location, $status, $image);

    if ($stmt->execute()) {
        $success_message = "Room added successfully!";
        header("refresh:2;url=index.php");
    } else {
        $error_message = "Error adding room. Please try again.";
    }
}
?>
...
<head>
    ...
    <title>Add Room | Room Booking</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">Add New Room</h4>
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="add_room.php" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="capacity" name="capacity" min="1" placeholder="Enter capacity" required>
                                            </div>
                                            
                                            <div class="mb-3">
                                                <label for="location" class="form-label">Location</label>
                                                <input type="text" class="form-control" id="location" name="location" placeholder="e.g., Floor 1, Building A" required>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <small class="text-muted">Upload an image of the room (optional)</small>
                                            </div>
